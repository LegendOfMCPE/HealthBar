...
class Loader extends PluginBase implements Listener{
    ...
    public function updateHealthBar(Player $player){
        ...
        if($style == "default"){
            ...
            $this->getLogger()->error("[HealthBar] Unknown style given. Player health bars will not be updated.");
            return false;
        }
        if($position == "above"){
            ...
            $this->getLogger()->error("[HealthBar] Unknown position given. Player health bars will not be updated.");
            return false;
        }
        return true;
    }
